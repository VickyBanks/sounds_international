/*
 ...
 Uses this table SELECT * FROM radio1_sandbox.dataforce_sounds_int_users_listening LIMIT 5;
 */
...
DROP TABLE IF EXISTS radio1_sandbox.dataforce_sounds_int_KPI_temp;
CREATE TABLE radio1_sandbox.dataforce_sounds_int_KPI_temp AS
...
INSERT INTO radio1_sandbox.dataforce_sounds_int_KPI_listeners
SELECT week_commencing,
       country,
       age_range,
...
/*DROP TABLE IF EXISTS radio1_sandbox.dataforce_sounds_int_KPI;
CREATE TABLE radio1_sandbox.dataforce_sounds_int_KPI
(
...
-- 2.a Insert data
INSERT INTO radio1_sandbox.dataforce_sounds_int_KPI
with visitors as (
    SELECT week_commencing,
           country,
           age_range,
    ...
    FROM radio1_sandbox.dataforce_sounds_int_KPI_temp
    GROUP BY 1, 2, 3, 4, 5
)
SELECT a.*, b.num_listeners
FROM visitors a
         LEFT JOIN radio1_sandbox.dataforce_sounds_int_KPI_listeners b ON
...
UPDATE radio1_sandbox.dataforce_sounds_int_KPI
SET app_type = (CASE
...
-- Grants
GRANT SELECT ON radio1_sandbox.dataforce_sounds_int_KPI TO GROUP radio;
GRANT SELECT ON radio1_sandbox.dataforce_sounds_int_KPI TO GROUP central_insights;
GRANT ALL ON radio1_sandbox.dataforce_sounds_int_KPI TO GROUP central_insights_server;
GRANT All ON radio1_sandbox.dataforce_sounds_int_KPI TO GROUP dataforce_analysts;

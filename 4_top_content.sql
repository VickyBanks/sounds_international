 ...
 */
 ...
 --Base data
/*SELECT * FROM radio1_sandbox.dataforce_sounds_int_users_listening LIMIT 50;
SELECT * FROM radio1_sandbox.dataforce_listeners_international_weekly_summary limit 50;
SELECT * FROM radio1_sandbox.dataforce_listeners_international LIMIT 50;
SELECT * FROM dataforce_vmb_summary where brand_title ILIKE '%Archers%' LIMIT 100;
*/
...
DROP TABLE IF EXISTS radio1_sandbox.dataforce_listeners_international_top_content;
CREATE TABLE radio1_sandbox.dataforce_listeners_international_top_content
...
INSERT INTO radio1_sandbox.dataforce_listeners_international_top_content
...
GRANT ALL ON radio1_sandbox.dataforce_listeners_international_top_content to vicky_banks;
...
FROM radio1_sandbox.dataforce_listeners_international_top_content
GROUP BY 1, 2)
...
DROP TABLE IF EXISTS radio1_sandbox.dataforce_listeners_international_top_content_user_info;
CREATE TABLE radio1_sandbox.dataforce_listeners_international_top_content_user_info AS
SELECT a.*,
...
FROM radio1_sandbox.dataforce_listeners_international_top_content a
...
GRANT ALL ON radio1_sandbox.dataforce_listeners_international_top_content_user_info to vicky_banks;

-- 3.Final table for top TLEO to be inserted into not dropped
/*DROP TABLE IF EXISTS radio1_sandbox.dataforce_listeners_international_top_content_final;
CREATE TABLE radio1_sandbox.dataforce_listeners_international_top_content_final
(
...
--3.a fill table
INSERT INTO radio1_sandbox.dataforce_listeners_international_top_content_final
...
FROM radio1_sandbox.dataforce_listeners_international_top_content_user_info
...
GRANT SELECT ON  radio1_sandbox.dataforce_listeners_international_top_content_final TO GROUP radio;
GRANT SELECT ON  radio1_sandbox.dataforce_listeners_international_top_content_final TO GROUP central_insights;
GRANT ALL ON  radio1_sandbox.dataforce_listeners_international_top_content_final TO GROUP central_insights_server ;
GRANT ALL ON  radio1_sandbox.dataforce_listeners_international_top_content_final TO GROUP dataforce_analysts;

---6.  The above table is HUGE to import to tableau so this next part finds just the top 10 tleos for each field combination
DROP TABLE IF EXISTS radio1_sandbox.dataforce_listeners_international_weekly_summary_top10_temp;
CREATE TABLE radio1_sandbox.dataforce_listeners_international_weekly_summary_top10_temp AS
SELECT *,
       row_number()
...
FROM radio1_sandbox.dataforce_listeners_international_top_content_final;
    --WHERE week_commencing = (SELECT distinct week_commencing FROM radio1_sandbox.dataforce_listeners_international_top_content_user_info) ;--TRUNC(DATE_TRUNC('week', getdate() - 7));

-- Select only top 10.
-- to be inserted into not dropped and re-created
/*DROP TABLE IF EXISTS radio1_sandbox.dataforce_listeners_international_weekly_summary_top10;
CREATE TABLE radio1_sandbox.dataforce_listeners_international_weekly_summary_top10
(
    week_commencing            date DISTKEY,
    country                    varchar(255),
    signed_in_status           varchar(10),
...
INSERT INTO radio1_sandbox.dataforce_listeners_international_weekly_summary_top10
SELECT a.*, b.master_brand_fancy_name
FROM radio1_sandbox.dataforce_listeners_international_weekly_summary_top10_temp a
...
UPDATE radio1_sandbox.dataforce_listeners_international_weekly_summary_top10
SET broadcast_type = (CASE
                          WHEN broadcast_type = 'Clip' THEN 'On-Demand'
                          WHEN broadcast_type = 'Live' THEN 'Live'
    WHEN broadcast_type = 'all' THEN 'All'
...
--- Check
SELECT week_commencing, count(*) FROM radio1_sandbox.dataforce_listeners_international_weekly_summary_top10 GROUP BY 1;

SELECT week_commencing, count(*) FROM radio1_sandbox.dataforce_listeners_international_top_content_final  GROUP BY 1;


GRANT SELECT ON  radio1_sandbox.dataforce_listeners_international_weekly_summary_top10 TO GROUP radio;
GRANT SELECT ON  radio1_sandbox.dataforce_listeners_international_weekly_summary_top10 TO GROUP central_insights;
GRANT ALL ON  radio1_sandbox.dataforce_listeners_international_weekly_summary_top10 TO GROUP central_insights_server;
GRANT ALL ON  radio1_sandbox.dataforce_listeners_international_weekly_summary_top10 TO GROUP dataforce_analysts;
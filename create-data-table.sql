...
SELECT dt,
       ...
       signed_in_status,
       CASE
           WHEN c.age_range = 'under 10' OR c.age_range = '11-15' THEN 'Under 16'
           WHEN c.age_range = '16-24' OR c.age_range = '25-34' THEN '16-34'
           WHEN c.age_range = 'unknown' THEN 'unknown'
...
SELECT * FROM radio1_sandbox.vb_sounds_dashboard_5_listening_international LIMIT 5;
SELECT * FROM radio1_sandbox.audio_content_enriched  LIMIT 10;
